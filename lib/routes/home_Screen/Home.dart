    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: widgetBottomNavigationBar(
          ...
          onTap: (index) {
            indexPageView = index;
            pageViewControlaer.animateToPage(index,
        ...
        body: PageView(
          ...
          // pageViewControlaer.animateToPage(1, duration: Duration(seconds: 4), curve: curve)

          children: [
            SizedBox(child: Home()),
            SizedBox(child: VentesScreen()),
            SizedBox(child: productScreen()),
            SizedBox(child: StatistiquesScreen()),
          ],
        ),
      ),
    );
                    ...
                    Expanded(
                      child: InkWell(
                        onTap: () {
                          tapButton1();
                          Navigator.of(context)
                              .pushNamed("La_case_Moeny Screen");
                        },
                        child: Container(
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return WidgetVeiwOrder(
                                ...
                                itemes_Product:
                                    Listx[index].values.first['itemes_Product'],
                                onTap: () {
                                  print("#################################");
                                  print(
                                      '${Listx[index].keys.toString().substring(1, Listx[index].keys.toString().length - 1)}');
