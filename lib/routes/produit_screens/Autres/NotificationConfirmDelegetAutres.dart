...
NotificationConfirmDelegetAutres(
  ...
  required String intituleAutres,
              ...
              Container(
                ...
                child: CustomGeneralButton(
                  ...
                  onTap: () {
                    ...
                    if (nameUser == "mohib") {
                      print(itemId);
                      CollectionReference refranceAutres = FirebaseFirestore
                          .instance
                          .collection("productAutres");
                      refranceAutres.doc(itemId).delete();
                      Navigator.of(context).pop();
...
Widget widgetVeiwProductaAutresLite({
  required String UrlImages,
  required String intituleAutres,
  required num QuantiteInitiale,
  required String dataEntree,
