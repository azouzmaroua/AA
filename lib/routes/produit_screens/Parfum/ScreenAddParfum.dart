...
class AddParfumScreen extends StatefulWidget {
  AddParfumScreen({Key? key}) : super(key: key);
      ...
      child: Scaffold(
              ...
              IconButton(
                  onPressed: () {
                    ...
                    Navigator.of(context)
                        .pushReplacementNamed('Parfum veiw Screen');
                  },
                  icon: Icon(Icons.arrow_back)),
              Text("Ajouter une parfum"),
              Text("     ")
            ],
          ),
        ...
        body: Padding(
          ...
          child: ListView(children: [
              ...
              return InkWell(
                  onTap: () {
                    ...
                    showBottomChoesImage(
                        context, "Gallery Images Parfum Screen");
                  },
            ...
            //name parfum…
            CompleteInfoItem(
              text: ' Entrez l’intitulé du parfum….',
            ...
            // Prix de l’unité
            CompleteInfoItem(
              text: ' Prix de l’unité (en ml)…',
              inputType: TextInputType.number,
              controller: _controllerPrixDeLunite,
            ),
            const VerticalSpace(4),
            // Quantite Initiale
            CompleteInfoItem(
              text: ' Quantité initiale (en ml)…',
              inputType: TextInputType.number,
            ...
            GeneralButton(
              text: "Enregistrer",
              onTap: () {
                //  addToFireBase.AddParfumScreen(_controller.text, double.parse(_controller2.text),double.parse( _controller3.text), int.parse( _controller4.text), double.parse(_controller5.text),double.parse( _controller6.text));
